...
options = {
    ...
    "30889": dict(
        ...
        ref="/SNS/users/m2d/git/quicknxs/test/notebooks/data/REF_M_30889+30890_Specular_Off_Off_v2_TOF_40.dat",
        # refcst='/SNS/users/m2d/MR/reflectivity_30889.txt',
        refcst="/SNS/users/m2d/git/quicknxs/test/notebooks/data/REF_M_30889+30890_Specular_Off_Off_CSTQ_v2_TOF_40.dat",
        peak_pos=157.5,
        peak=[149, 167],
        bck=[47, 105],
        beam=[75, 161],
