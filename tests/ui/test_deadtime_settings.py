...
def test_show_deadtime_settings_default_values(mocker, qtbot):
    ...
    mock_reload_files = mocker.patch("quicknxs.views.main_window.MainWindow.reload_all_files")
...
def test_show_deadtime_settings_updated_values(mocker, qtbot):
    ...
    mocker.patch("quicknxs.views.deadtime_settings.DeadTimeSettingsView.ask_user_ok_to_reload_files", return_value=True)
    mock_reload_files = mocker.patch("quicknxs.views.main_window.MainWindow.reload_all_files")
