...
class PlotPresenter:
    ...
    def change_region_values(self):
        ...
        """
        if self.plot_view.proj_lines is None:
            return
        lines = self.plot_view.proj_lines
        ...
        if not self.ui.tthPhi.isChecked():
            self.plot_view.xy_x1.set_xdata([x_peak - x_width / 2.0, x_peak - x_width / 2.0])
            self.plot_view.xy_x2.set_xdata([x_peak + x_width / 2.0, x_peak + x_width / 2.0])
            self.plot_view.xy_y1.set_ydata([y_pos - y_width / 2.0, y_pos - y_width / 2.0])
            self.plot_view.xy_y2.set_ydata([y_pos + y_width / 2.0, y_pos + y_width / 2.0])
            self.ui.xy_overview.draw()

        self.plot_view.xtof_x1.set_ydata([x_peak - x_width / 2.0, x_peak - x_width / 2.0])
        self.plot_view.xtof_x2.set_ydata([x_peak + x_width / 2.0, x_peak + x_width / 2.0])
        self.plot_view.xtof_bck1.set_ydata([bg_pos - bg_width / 2.0, bg_pos - bg_width / 2.0])
        self.plot_view.xtof_bck2.set_ydata([bg_pos + bg_width / 2.0, bg_pos + bg_width / 2.0])
    ...
    def change_offspec_colorscale(self):
        ...
        self.plot_view.plot_offspec(recalc=False)
