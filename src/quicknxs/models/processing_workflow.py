...
class ProcessingWorkflow:
    ...
    def __init__(self, data_manager: DataManager, output_options: OutputOptions | None = None):
    ...
    def write_orso(self, output_data: dict[str, np.ndarray]):
        ...
        run_list = [str(item.run_number) for item in self.data_manager.reduction_list]
    ...
    def smooth_offspec(self, data_dict: dict) -> tuple[dict, dict]:
        ...
        for xs in data_dict["cross_sections"].keys():
            ...
            x, y, I = off_specular.smooth_data(
                ...
                gridx=self.output_options.off_spec_smooth_nxbins,
                gridy=self.output_options.off_spec_smooth_nybins,
