...
from quicknxs.models.gisans import GISANS
from quicknxs.models.off_specular import OffSpecular
...
class NexusData(object):
    ...
    def calculate_reflectivity(
        ...
        data_presenter.set_active_reduction_list_index(peak_index)
